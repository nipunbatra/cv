% Conditional compilation: set \cvshort to true for short version
\newif\ifcvshort
\cvshortfalse % Default to full version
...
\fancyhf{}
\fancyfoot[L]{\small\textcolor{gray}{Last updated: \today}}
\fancyfoot[C]{\small\textcolor{gray}{Nipun Batra • \href{mailto:nipun.batra@iitgn.ac.in}{nipun.batra@iitgn.ac.in}}}
...
\vspace{-0.4em}
Summary: 13+ sponsored projects and consultancies, approximately 5.8+ crore INR raised
\begin{itemize}
    \item[]{\textbf{PI: }Scalable Detection of Brick Kilns from Low Resolution Satellite Imagery for Environmental Compliance}\hfill\textit{2026} \\
        ANRF Research Grant, ANRF/ARG/2025/002304/ENS (Amount: $\approx$ Rs. 91 lacs, 2026--2030)
    \item[]{\textbf{PI: }Automated Crop Mapping}\hfill\textit{2026} \\
        ISRO (Amount: $\approx$ Rs. 30 lacs)
    \item[]{\textbf{PI: }Gemini Academic Program Award}\hfill\textit{2026} \\
        Google (research credits)
    \item[]{\textbf{Co-PI: }Smart Metering \& Energy Solutions with Data Analytics \& EaaS}\hfill\textit{2024} \\
        Reliance Jio Platforms Ltd.\ consultancy (Amount: $\approx$ Rs. 64 lacs)
    \item[]{\textbf{PI: }Progressive Web Applications for Geospatial Analysis (DEM, NDVI, EVI in Gujarat)}\hfill\textit{2025} \\
        Gujarat Forest Department consultancy (Amount: $\approx$ Rs. 6.5 lacs)
...
\vspace{-0.4em}
\begin{itemize}
\item[]{Best Paper Award Runner-Up, ACM BuildSys} \hfill\textit{2026}\\
    \textit{For NILMBench: A Benchmark for Energy Disaggregation (paper led by three second-year B.Tech.\ students)}

\item[]{ACM SIGEnergy Rising Star Award} \hfill\textit{2025}\\
...
\item[]{ACM e-Energy Test of Time Award (for NILMTK)} \hfill\textit{2025}\\
...
\vspace{-0.4em}
\begin{itemize}
\item[]{Best Paper Award Runner-Up at ACM BuildSys 2026 won by three second-year B.Tech.\ students (Aayush Kuloor, Anurag Singh, Harsh Dhru) for NILMBench} \hfill\textit{2026}
\item[]{M.Tech. students Parv Thacker, Saaransh Shandilya, and Balbir Prasad awarded IndiaAI Fellowships (MeitY, Govt.\ of India)} \hfill\textit{2026}
\item[]{Ph.D. student Ayush Shrivastava awarded the ACM SIGKDD (KDD) Student Travel Award} \hfill\textit{2026}
\item[]{Ph.D. student Zeel B Patel awarded the Microsoft Research PhD Fellowship} \hfill\textit{2024}
...
\item[]{Ph.D. student Rishiraj Adhikary selected for the Lindau Nobel Laureate Meeting} \hfill\textit{2024}
...
\vspace{-0.4em}
\begin{itemize}
\item[] \textbf{Software Tools and Techniques for AI} (new course): Spring 2026
\item[] \textbf{Principles of AI} (new course; taught in both English and Hindi sections): Spring 2026
\item[] \textbf{Machine Learning}: Fall 2025, Spring 2025, Fall 2024, Spring 2024, Spring 2023, Spring 2022, Spring 2021, Spring 2020, Spring 2019
...
\item[] \textbf{Open teaching beyond the classroom}: full course lecture series (Machine Learning, Probabilistic ML, Data Visualization, Software Tools for AI) freely available on \href{https://www.youtube.com/@NipunBatra0}{YouTube} --- 278 videos, 178,000+ views
...
Citation Summary (as of \today)\\
Total citations - 3,690+, h-Index - 21, i10-Index: 29

A*, A conferences or Q1 journals are highlighted using \textbf{*}

\begin{itemize}
    \item[]\textbf{Selected Peer-reviewed articles}
    \begin{enumerate}

    \item{Ayush Shrivastava, Kirtan Gangani, Laksh Jain, Mayank Goel, \textbf{Nipun Batra}}\\
    \textit{ThermEval: A Structured Benchmark for Evaluation of Vision-Language Models on Thermal Imagery}\\
    \textbf{*~}{ACM SIGKDD Conference on Knowledge Discovery and Data Mining (KDD), Datasets \& Benchmarks Track, 2026}

    \item{Zeel B Patel, Vinayak Rana, \textbf{Nipun Batra}}\\
    \textit{Scalable Air-Quality Sensor Placement via Gradient-Based Mutual Information Maximization}\\
    \textbf{*~}{AAAI Conference on Artificial Intelligence (AI for Social Impact Track), 2026}

    \item{Aayush Kuloor, Anurag Singh, Harsh Dhru, \textbf{Nipun Batra}}\\
    \textit{NILMBench: A Benchmark for Energy Disaggregation}\\
    \textbf{*~}{ACM BuildSys, 2026 \textbf{[\includegraphics[height=0.8em]{trophy.pdf}~ Best Paper Award Runner-Up]}}

    \item{Rishabh Mondal, Jeet Parab, Heer Kubadia, Shataxi Dubey, Shardul Junagade, Zeel B Patel, \textbf{Nipun Batra}}\\
    \textit{SentinelKilnDB: A Large-Scale Dataset and Benchmark for OBB Brick Kiln Detection in South Asia Using Satellite Imagery}\\
    \textbf{*~}{Advances in Neural Information Processing Systems (NeurIPS), 2025}

    \item{\textbf{Nipun Batra}, B Coleppa, A Khanna, SK Rai, A Sarkar}\\
    \textit{Constraining the 3HDM parameter space using active learning}\\
    \textbf{*~}{Physical Review D 112 (1), 015011, 2025}

    \item{Nishchaya Kumar Mishra, \textbf{Nipun Batra}, Sameer Patel}\\
    \textit{Optimizing Pollutant Exposure, Energy Consumption, and Thermal Comfort in a House via Deep Reinforcement Learning Control}\\
    \textbf{*~}{Journal of Building Engineering, 2025}

    \item{Haikoo Khandor, R Yeeshu Dhurandhar, Dhairya Shah, \textbf{Nipun Batra}}\\
    \textit{Distribution-Free Uncertainty Quantification and Calibration for Energy Disaggregation}\\
    {ACM Journal on Computing and Sustainable Societies (JCSS), 2025}\\
    \href{https://doi.org/10.1145/3748334}{https://doi.org/10.1145/3748334}
    ...
    \textit{SpiroMask: measuring Lung function using consumer-grade masks}\\
      \textbf{*~}{ACM Transactions on Computing for Healthcare, 2023}
...
\textit{Vastr-GAN: versatile apparel synthesised from text using a robust generative adversarial network}\\
    ...
    \item{Davinder Singh, Naman Jain, Pranjali Jain, Prateek Kayal, Sudhakar Kumawat, \textbf{Nipun Batra}}\\
    \textit{PlantDoc: A Dataset for Visual Plant Disease Detection}\\
    {CODS COMAD 2020 \textbf{(\includegraphics[height=0.8em]{trophy.pdf}~ 1,000+ citations; undergraduate-led)}}
    ...
    \textbf{*~}{Buildsys 2019 \textbf{(175+ citations)}}
 ...
 \textit{Gemello: Creating a Detailed Energy Breakdown from just the Monthly Electricity Bill}\\
	...
	\item 
		...
		{ACM eEnergy 2014. Cambridge, UK \textbf{(Acceptance rate: 20\%, \includegraphics[height=0.8em]{trophy.pdf}~ 780+ citations)}}
    ...
    \textbf{*~}{Buildsys 2013, Rome, Italy \textbf{(260+ citations)}}
   ...
   \item 
	 ...
	 \textbf{*~}{Buildsys 2012, Waterloo, Canada, \textbf{(75+ citations)}}	
    ...
    \begin{enumerate}
        \item{Vedant Acharya, Abhay Pisharodi, Ratnesh Pasi, Rishabh Mondal, \textbf{Nipun Batra}}\\
        \textit{VayuBench and VayuChat: Executable Benchmarking and Deployment of LLMs for Multi-Dataset Air Quality Analytics}\\
        {ACM IKDD CODS (Applied Data Science Track), 2025}

        \item{Parv Thacker, Ayush Shrivastava, \textbf{Nipun Batra}}\\
        \textit{Feature-Informed Self-Supervised Learning for Time Series Understanding}\\
        {MILETS Workshop @ ACM SIGKDD (oral), 2026}
		...
		{GlobalSip, Orlando, FL, USA} {\textbf{(220+ citations)}}
...
\vspace{-0.4em}
\begin{itemize}
\item[]{\textit{A System and Method for Non-Contact Screening and Classification of Sleep Apnea} (ApneaEye)} \hfill\textit{2025}\\
    Indian Patent Application No.\ 202521107821, filed 06 Nov 2025 (with Rishiraj Adhikary, Ayush Shrivastava, Mayank Goel, and Dr.\ Saurabh Mittal)
\end{itemize}
...
\itemsep0em
\item[] \textbf{National and Government Service}
\itemsep0em
    \begin{itemize}
    \item Expert Committee, IndiaAI Mission (MeitY) --- technical \& financial evaluation of national AI proposals \hfill\textit{2026}
    \item Member, Project Review \& Steering Group (PRSG), MeitY --- national e-governance projects \hfill\textit{2026}
    \item Member, Technical Committee, Central Pollution Control Board (CPCB) --- automated quality control of national air-quality (CAAQMS) data \hfill\textit{2026}
    \item Expert Committee (Engineering Science), ANRF National Post-Doctoral Fellowships \hfill\textit{2026}
    \item Member, Gujarat State AI Task Force \hfill\textit{2024--25}
    \end{itemize}
\itemsep0em
\item[] \textbf{Professional Community}
\itemsep0em
    \begin{itemize}
    \item ACM India Summer Schools Committee \hfill\textit{2026}
    \item Lead Organizer, ACM India Summer School on AI for Social Good, IIT Gandhinagar \hfill\textit{2025}
    \item ACM SIGEnergy Rising Star Award Committee \hfill\textit{2026}
    \end{itemize}
\itemsep0em
\item[] \textbf{TPC / Reviewer (recent only)}
\itemsep0em
    \begin{itemize}
    \item ACM Buildsys 2025
    \item AAAI 2026 (AI for Social Impact)
    \item ACM CODS 2025
    \item NeurIPS 2025 (Datasets \& Benchmarks), ICLR 2026, KDD 2026 (Datasets \& Benchmarks), ACL Rolling Review 2026, ACM UIST 2026
    \end{itemize}
\itemsep0em 
\item[] \textbf{Publicity Chair}
\itemsep0em 
    \begin{itemize}
    \item ACM eEnergy 2026
    \end{itemize}
...
\subsection*{\textbf{Media Coverage and Outreach}}
\vspace{-0.4em}
\begin{itemize}
\itemsep0em 
    \item[] \textbf{VayuBuddy Project Coverage} \hfill \textit{2024}
    \begin{itemize}
    \item Indian Express, Ahmedabad Mirror, Divya Bhaskar, Chitralekha
    \end{itemize}
    
    \item[] \textbf{JoulesEye Project Coverage} \hfill \textit{2024}
    \begin{itemize}
    \item Hackster.io, Indian Express, Carnegie Mellon University News, ZME Science, TechXplore, EurekaAlert
    \end{itemize}
    
    \item[] \textbf{Fulbright-Nehru Fellowship Coverage} \hfill \textit{2022}
    \begin{itemize}
    \item Education Times, Indian Express, Ahmedabad Mirror, India Education Diary, Careers 360
    \end{itemize}
    
    \item[] \textbf{SpiroMask Project Coverage} \hfill \textit{2023}
    \begin{itemize}
    \item Ahmedabad Mirror, EdgeImpulse
    \end{itemize}
\end{itemize}
...
\subsection*{\textbf{Computational Infrastructure}}
\vspace{-0.4em}
\begin{itemize}
\itemsep0em 
    \item[] \textbf{High-Performance Computing Servers}
    \begin{itemize}
    \item \textbf{Ramanujan}: 512 GB RAM, AMD EPYC 7452 32-Core, 4x NVIDIA A100-SXM4 (80GB each), 8TB storage
    \item \textbf{Bhaskar}: 256 GB RAM, Intel Gold ICX 6326, 2x NVIDIA RTX A5000 (24GB each), 5TB storage  
    \item \textbf{Sustain}: 192 GB RAM, Intel Xeon Silver 4208, 2x NVIDIA RTX A4000 (16GB each), 2TB storage
    \end{itemize}
    
    \item[] \textbf{Research Workstations}
    \begin{itemize}
    \item \textbf{Aryabhata}: 32 GB RAM, Intel Core i9-13900, NVIDIA RTX Titan XP (12GB), 2TB storage
    \item \textbf{Vikram}: 64 GB RAM, Intel Core i9-14700, NVIDIA RTX A2000 (12GB), 4TB storage
    \end{itemize}
    
    \item[] \textbf{Total Computing Resources}: 1TB+ combined RAM, 400+ GB GPU VRAM, 21TB+ storage
\end{itemize}
\fi
...
\begin{itemize}
      \item[] {Invited Lecturer, Climate Change AI Virtual Summer School (``AI for Buildings'')} \hfill \textit{2026}
      \item[] {TCS Research, IIT Delhi: \textit{Sensing the Invisible: AI for Cleaner Air and Better Sleep}} \hfill \textit{2026}
      \item[] {IIIT Delhi Alumni Talk and podcast} \hfill \textit{2026}
      \item[] {Keynote Panelist, Electronics Education Congress, EFY Expo Gujarat} \hfill \textit{2025}
